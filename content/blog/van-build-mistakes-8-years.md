---
title: "Van Build Mistakes We've Seen (And a Few We Made) — What We'd Do Differently"
date: 2026-03-04
description: "8 years of full-time van life reveals the build decisions that cause long-term problems — and the ones that were worth every penny."
featureimage: "/images/featured/power-stations.svg"
featured_image: "/images/featured/power-stations.svg"
categories: ["blog"]
tags: ["van-build", "van-life", "practical-tips", "promaster"]
---
...
This one comes up constantly, and it takes about a week of rough road driving to understand why.
...
120V AC wiring inside a van adds complexity and fire risk that most builds don't need. The instinct is understandable — most appliances run on AC, so putting AC outlets throughout the van feels like a complete solution.
...
Florida changed how we think about this.

Humidity works its way into every gap and seam. The ProMaster's steel structure starts from the factory with some protection, but a van build disrupts that — you're drilling holes, cutting openings, running wires through surfaces, removing factory panels. Each intervention is an entry point for moisture.

In a dry climate like Colorado or Arizona, this isn't immediately visible. In Florida humidity, the rust comes faster than you expect and in places you can't easily see — behind panels, in floor channels, along weld seams.
...
A ceiling rack that pushes the van over 9 feet closes you off from drive-throughs, most parking garages, and a significant number of covered areas. On a high-roof ProMaster — which starts at approximately 9 feet 1 inch stock — a standard rack height can push you to 9 feet 4 or 9 feet 6. That's over the line.

Low-profile racks exist specifically because this problem is common. The Vantech low-profile design keeps a loaded ProMaster under 9 feet. It costs more than standard racks. The cost is worth it.

The secondary issue: roof-mounted Maxxair fans, when raised, add another 4–5 inches. Even with a low-profile rack, raised fans push the van over 9 feet. The habit to build: lower fans before any low-clearance entry. Every time. Without exception.

## Mistake 5: Choosing Sliding Windows Over T-Vent

We did both sides vented — which was the right call and we'd do it again. The style choice was the debate.
...
My girlfriend pushed for T-vent from the start. I defaulted to sliding because it's what I'd seen most. She was right. After years of use, the T-vent on the non-sliding door side has been clearly the better window — less road noise, more confidence in the open position, better long-term durability.

When someone who's going to use the van every day has a strong preference about something they'll interact with constantly, that preference is usually worth listening to.

## What We Got Right

**Both sides vented.** Van airflow requires a source and an exhaust. One window only creates a partial path. Both sides opened together — sliding door side and fixed wall side — creates real crossflow that makes a meaningful difference in heat and condensation management.
